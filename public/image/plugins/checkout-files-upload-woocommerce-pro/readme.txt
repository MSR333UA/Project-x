=== Checkout Files Upload for WooCommerce Pro ===
Contributors: wpwham
...
= 2.0.0 =
This is a major update, including added support for multiple file uploads in one button.  There are some possibly breaking changes in the template settings.  If you use the default template you have nothing to worry about, however if you customized your template please read the changelog carefully and double check your settings to make sure everything is correct.
