	...
	public static function get_settings() {
		$settings = array(
			...
			array(
				...
				'desc_tip' => 
					__( 'Checkout Files Upload for WooCommerce Pro', 'checkout-files-upload-woocommerce' )
					. ' v' . WPWHAM_CHECKOUT_FILES_UPLOAD_PRO_VERSION . '.<br />'
					. '<a href="https://wpwham.com/documentation/checkout-files-upload-for-woocommerce/?utm_source=documentation_link&utm_campaign=premium&utm_medium=checkout_files_upload" target="_blank" class="button">' .
			...
			array(
				'title'    => __( 'License Key', 'checkout-files-upload-woocommerce' ),
				'id'       => 'wpwham_checkout_files_upload_license',
				'desc_tip' => __( 'Enter the license key from your purchase to enable updates and support.', 'checkout-files-upload-woocommerce' ),
				'type'     => 'text',
				'desc'     => apply_filters(
					'wpwham_checkout_files_upload_option_field',
