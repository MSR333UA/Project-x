...
if ( $attachment_ids ) {
	...
	<div class="vu_p-image-thumbs">
		<div class="thumbnails <?php echo 'columns-' . $columns; ?> vu_owl-carousel" data-options="<?php echo esc_attr(json_encode($carousel_options)); ?>"><?php

			foreach ( $attachment_ids as $attachment_id ) {

				$classes = array( 'vu_p-image-thumb vu_p-image-zoom' );
