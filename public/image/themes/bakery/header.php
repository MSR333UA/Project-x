			...
			<header id="vu_main-header" class="vu_main-header" role="banner" itemscope="itemscope" itemtype="https://schema.org/WPHeader">
				<?php if( vu_get_option('top-bar') ) : ?>
					<div class="vu_top-bar">
						<div class="container">
							<div class="row">
								<div class="vu_tp-left col-md-4">
									<?php echo do_shortcode( vu_get_option('top-bar-left') ); ?>
								</div>
								<div class="vu_tp-right col-md-8">
									
								<?php	if( is_user_logged_in()) {  ?>
									<nav class="my-top-menu vu_mm-right" role="navigation" itemscope="itemscope" itemtype="https://schema.org/SiteNavigationElement">
																<?php 
																	// Main Menu Right
																	wp_nav_menu(array(
									...
									<?php } else { ?>
											<nav class="my-top-menu vu_mm-left" role="navigation" itemscope="itemscope" itemtype="https://schema.org/SiteNavigationElement">
														<?php 
															// Main Menu Left
															wp_nav_menu(array(
