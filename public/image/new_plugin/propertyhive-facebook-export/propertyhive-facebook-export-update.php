...
/*
*  properthive_facebook_export_update
*
...
class properthive_facebook_export_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-facebook-export-m3uvdae21/update-info.php',
...
if( is_admin() )
{
	new properthive_facebook_export_update();
}
