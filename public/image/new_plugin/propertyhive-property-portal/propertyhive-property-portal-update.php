...
/*
*  properthive_property_portal_update
*
...
class properthive_property_portal_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-property-portal-gd50a1qx/update-info.php',
...
if( is_admin() )
{
	new properthive_property_portal_update();
}
