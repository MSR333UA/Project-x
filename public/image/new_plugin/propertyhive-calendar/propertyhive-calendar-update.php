...
class properthive_calendar_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-calendar-f6bsfrr11/update-info.php',
...
if( is_admin() )
{
	new properthive_calendar_update();
}
