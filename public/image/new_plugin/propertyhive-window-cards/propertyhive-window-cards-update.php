...
/*
*  properthive_window_cards_update
*
...
class properthive_window_cards_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-window-cards-g53jjj7d/update-info.php',
...
if( is_admin() )
{
	new properthive_window_cards_update();
}
