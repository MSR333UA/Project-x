...
/*
*  properthive_send_to_friend_update
*
...
class properthive_send_to_friend_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-send-to-friend-f43ghk02/update-info.php',
...
if( is_admin() )
{
	new properthive_send_to_friend_update();
}
