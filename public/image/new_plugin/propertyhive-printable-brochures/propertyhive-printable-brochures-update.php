...
/*
*  properthive_printable_brochures_update
*
...
class properthive_printable_brochures_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-printable-brochures-a64aan0v/update-info.php',
...
if( is_admin() )
{
	new properthive_printable_brochures_update();
}
