...
/*
*  properthive_board_management_update
*
...
class properthive_board_management_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-board-management-caa32v1dds/update-info.php',
...
if( is_admin() )
{
	new properthive_board_management_update();
}
