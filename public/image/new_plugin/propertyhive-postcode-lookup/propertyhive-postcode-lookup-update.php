...
/*
*  properthive_postcode_lookup_update
*
...
class properthive_postcode_lookup_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-postcode-lookup-r15xaf0l/update-info.php',
...
if( is_admin() )
{
	new properthive_postcode_lookup_update();
}
