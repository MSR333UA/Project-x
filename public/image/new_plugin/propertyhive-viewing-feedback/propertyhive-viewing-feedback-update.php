...
/*
*  properthive_viewing_feedback_request_update
*
...
class properthive_viewing_feedback_request_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-viewing-feedback-h17tyj1g/update-info.php',
...
if( is_admin() )
{
	new properthive_viewing_feedback_request_update();
}
