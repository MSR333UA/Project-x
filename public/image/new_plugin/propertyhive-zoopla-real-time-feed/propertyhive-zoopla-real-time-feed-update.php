...
/*
*  properthive_zoopla_real_time_feed_update
*
...
class properthive_zoopla_real_time_feed_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-zoopla-real-time-feed-h61bgd7s/update-info.php',
...
if( is_admin() )
{
	new properthive_zoopla_real_time_feed_update();
}
