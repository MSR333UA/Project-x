...
/**
 * PH_Meta_Box_Contact_Tasks
 */
class PH_Meta_Box_Contact_Tasks {
	...
	public static function output( $post, $args = array() ) {
        ...
        echo '<div id="propertyhive_tasks_grid" data-related-to="contact|' . $thepostid . '" class="tasks-grid">Loading Tasks...</div>';
        ...
        echo '<div id="create_task_form" class="create-task-form">';
            ...
            echo '<input type="hidden" name="_task_related_to" id="_task_related_to" value="contact|' . $thepostid . '">';
