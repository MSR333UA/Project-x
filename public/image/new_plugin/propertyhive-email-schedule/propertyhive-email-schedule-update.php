...
/*
*  properthive_email_schedule_update
*
...
class properthive_email_schedule_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-email-schedule-t5nffer21/update-info.php',
...
if( is_admin() )
{
	new properthive_email_schedule_update();
}
