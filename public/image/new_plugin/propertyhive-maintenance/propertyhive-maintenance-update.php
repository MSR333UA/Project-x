...
/*
*  properthive_maintenance_update
*
...
class properthive_maintenance_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-maintenance-vrr42j9vfd/update-info.php',
...
if( is_admin() )
{
	new properthive_maintenance_update();
}
