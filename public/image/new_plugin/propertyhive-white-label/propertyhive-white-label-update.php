...
/*
*  properthive_white_label_update
*
...
class properthive_white_label_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-white-label-v54lcq22/update-info.php',
...
if( is_admin() )
{
	new properthive_white_label_update();
}
