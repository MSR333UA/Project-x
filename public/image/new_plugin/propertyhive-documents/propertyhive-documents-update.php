...
class properthive_documents_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-documents-g1emnbk77/update-info.php',
...
if( is_admin() )
{
	new properthive_documents_update();
}
