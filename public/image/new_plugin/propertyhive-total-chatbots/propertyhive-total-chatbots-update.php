...
/*
*  properthive_total_chatbots_update
*
...
class properthive_total_chatbots_update
{
	var $settings;
	...
	*/
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-total-chatbots-d1trkj58v/update-info.php',
...
if( is_admin() )
{
	new properthive_total_chatbots_update();
}
