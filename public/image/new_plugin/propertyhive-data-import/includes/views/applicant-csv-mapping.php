<div class="wrap propertyhive">
    ...
    <form method="post">
        ...
        <?php wp_nonce_field( 'import-applicant-csv' ); ?>
        ...
        <?php wp_nonce_field( 'import-applicant-csv-mapping', 'applicant_csv_mapping_none' ); ?>
        ...
        <input type="submit" class="button-primary" value="Import Applicant CSV">
