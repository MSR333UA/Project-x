...
/*
*  properthive_data_import_update
*
...
class properthive_data_import_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-data-import-h75ger9e/update-info.php',
...
if( is_admin() )
{
	new properthive_data_import_update();
}
