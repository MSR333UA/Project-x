...
class properthive_what3words_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-what3words-g11can9z/update-info.php',
...
if( is_admin() )
{
	new properthive_what3words_update();
}
