...
$additional_shortcodes['[ihc-login-popup] ... [/ihc-login-popup]'] = __( 'Login form inside a modal', 'ihc' );
$additional_shortcodes['[ihc-register-popup] ... [/ihc-register-popup]'] = __( 'Register lite inside a modal', 'ihc' );
