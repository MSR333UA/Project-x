...
/*
*  properthive_location_autocomplete_update
*
...
class properthive_location_autocomplete_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-location-autocomplete-r33fvw65/update-info.php',
...
if( is_admin() )
{
	new properthive_location_autocomplete_update();
}
