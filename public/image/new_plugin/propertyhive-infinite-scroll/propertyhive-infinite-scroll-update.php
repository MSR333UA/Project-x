...
/*
*  properthive_infinite_scroll_update
*
...
class properthive_infinite_scroll_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-infinite-scroll-c51hjk7l/update-info.php',
...
if( is_admin() )
{
	new properthive_infinite_scroll_update();
}
