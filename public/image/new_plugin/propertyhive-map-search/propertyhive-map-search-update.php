...
class properthive_map_search_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-map-search-g11can9z/update-info.php',
...
if( is_admin() )
{
	new properthive_map_search_update();
}
