...
/*
*  properthive_moving_cost_calculator_update
*
...
class properthive_moving_cost_calculator_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-moving-cost-calculator-v766m1vg/update-info.php',
...
if( is_admin() )
{
	new properthive_moving_cost_calculator_update();
}
