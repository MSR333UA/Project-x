 ...
 * Plugin Uri: http://wp-property-hive.com/addons/valpal-instant-valuation/
...
final class PH_ValPal {
    ...
    public function valpal_shortcode() 
    {
        ...
        $translation_array = apply_filters( 'propertyhive_valpal_translation_array', array(
            'address_lookup' => isset($current_settings['address_lookup']) ? $current_settings['address_lookup'] : '',
        ...
        wp_localize_script( 'ph-valpal', 'propertyhive_valpal', $params );
...
<?php
    ...
    public function save() {
        ...
        $propertyhive_valpal = array(
            ...
            'address_lookup_username' => ( (isset($_POST['address_lookup_username'])) ? $_POST['address_lookup_username'] : '' ),
            'address_lookup_password' => ( (isset($_POST['address_lookup_password'])) ? $_POST['address_lookup_password'] : '' ),
