...
/*
*  properthive_frontend_property_submissions_update
*
...
class properthive_frontend_property_submissions_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-frontend-property-submissions-11yt5vaj/update-info.php',
...
if( is_admin() )
{
	new properthive_frontend_property_submissions_update();
}
