...
class properthive_shortlist_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-shortlist-x33avk9l/update-info.php',
...
if( is_admin() )
{
	new properthive_shortlist_update();
}
