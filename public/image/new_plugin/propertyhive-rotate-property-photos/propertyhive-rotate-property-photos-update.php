...
/*
*  properthive_rotate_property_photos_update
*
...
class properthive_rotate_property_photos_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://wp-property-hive.com/add-on-store/propertyhive-rotate-property-photos-v57mmf1l/update-info.php',
...
if( is_admin() )
{
	new properthive_rotate_property_photos_update();
}
